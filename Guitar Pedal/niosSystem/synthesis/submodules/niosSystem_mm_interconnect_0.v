// niosSystem_mm_interconnect_0.v
...
`timescale 1 ps / 1 ps
module niosSystem_mm_interconnect_0 (
	...
	wire  [92:0] sysid_qsys_0_control_slave_agent_rf_source_data;                                    // sysid_qsys_0_control_slave_agent:rf_source_data -> sysid_qsys_0_control_slave_agent_rsp_fifo:in_data
	...
	wire  [92:0] sysid_qsys_0_control_slave_agent_rsp_fifo_out_data;                                 // sysid_qsys_0_control_slave_agent_rsp_fifo:out_data -> sysid_qsys_0_control_slave_agent:rf_sink_data
	...
	wire  [91:0] cmd_mux_001_src_data;                                                               // cmd_mux_001:src_data -> sysid_qsys_0_control_slave_agent:cp_data
	...
	wire  [91:0] cmd_mux_003_src_data;                                                               // cmd_mux_003:src_data -> onchip_memory2_0_s1_agent:cp_data
	...
	wire  [15:0] green_leds_s1_agent_m0_address;                                                     // green_leds_s1_agent:m0_address -> green_leds_s1_translator:uav_address
	...
	wire  [92:0] green_leds_s1_agent_rf_source_data;                                                 // green_leds_s1_agent:rf_source_data -> green_leds_s1_agent_rsp_fifo:in_data
	...
	wire  [92:0] green_leds_s1_agent_rsp_fifo_out_data;                                              // green_leds_s1_agent_rsp_fifo:out_data -> green_leds_s1_agent:rf_sink_data
	...
	wire         cmd_mux_004_src_valid;                                                              // cmd_mux_004:src_valid -> green_leds_s1_agent:cp_valid
	wire  [91:0] cmd_mux_004_src_data;                                                               // cmd_mux_004:src_data -> green_leds_s1_agent:cp_data
	wire         cmd_mux_004_src_ready;                                                              // green_leds_s1_agent:cp_ready -> cmd_mux_004:src_ready
	wire   [4:0] cmd_mux_004_src_channel;                                                            // cmd_mux_004:src_channel -> green_leds_s1_agent:cp_channel
	wire         cmd_mux_004_src_startofpacket;                                                      // cmd_mux_004:src_startofpacket -> green_leds_s1_agent:cp_startofpacket
	wire         cmd_mux_004_src_endofpacket;                                                        // cmd_mux_004:src_endofpacket -> green_leds_s1_agent:cp_endofpacket
	...
	wire  [91:0] sysid_qsys_0_control_slave_agent_rp_data;                                           // sysid_qsys_0_control_slave_agent:rp_data -> router_003:sink_data
	...
	wire  [91:0] onchip_memory2_0_s1_agent_rp_data;                                                  // onchip_memory2_0_s1_agent:rp_data -> router_005:sink_data
	...
	wire         green_leds_s1_agent_rp_valid;                                                       // green_leds_s1_agent:rp_valid -> router_006:sink_valid
	wire  [91:0] green_leds_s1_agent_rp_data;                                                        // green_leds_s1_agent:rp_data -> router_006:sink_data
	wire         green_leds_s1_agent_rp_ready;                                                       // router_006:sink_ready -> green_leds_s1_agent:rp_ready
	wire         green_leds_s1_agent_rp_startofpacket;                                               // green_leds_s1_agent:rp_startofpacket -> router_006:sink_startofpacket
	wire         green_leds_s1_agent_rp_endofpacket;                                                 // green_leds_s1_agent:rp_endofpacket -> router_006:sink_endofpacket
	...
	wire         green_leds_s1_agent_rdata_fifo_src_valid;                                           // green_leds_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_004:in_0_valid
	wire  [33:0] green_leds_s1_agent_rdata_fifo_src_data;                                            // green_leds_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_004:in_0_data
	wire         green_leds_s1_agent_rdata_fifo_src_ready;                                           // avalon_st_adapter_004:in_0_ready -> green_leds_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_004_out_0_valid;                                                  // avalon_st_adapter_004:out_0_valid -> green_leds_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_004_out_0_data;                                                   // avalon_st_adapter_004:out_0_data -> green_leds_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_004_out_0_ready;                                                  // green_leds_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_004:out_0_ready
	wire   [0:0] avalon_st_adapter_004_out_0_error;                                                  // avalon_st_adapter_004:out_0_error -> green_leds_s1_agent:rdata_fifo_sink_error
	...
	niosSystem_mm_interconnect_0_router router (
	...
	niosSystem_mm_interconnect_0_router_001 router_001 (
	...
	niosSystem_mm_interconnect_0_router_002 router_002 (
	...
	niosSystem_mm_interconnect_0_router_002 router_003 (
	...
	niosSystem_mm_interconnect_0_router_004 router_004 (
	...
	niosSystem_mm_interconnect_0_router_004 router_005 (
	...
	niosSystem_mm_interconnect_0_router_002 router_006 (
	...
	niosSystem_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (clk_50mhz_clk_clk),                                      //        clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset),         //  clk_reset.reset
	...
	niosSystem_mm_interconnect_0_cmd_demux_001 cmd_demux_001 (
		.clk                (clk_50mhz_clk_clk),                                             //        clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset),                //  clk_reset.reset
	...
	niosSystem_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (clk_50mhz_clk_clk),                              //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	niosSystem_mm_interconnect_0_cmd_mux cmd_mux_001 (
		.clk                 (clk_50mhz_clk_clk),                              //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	niosSystem_mm_interconnect_0_cmd_mux_002 cmd_mux_002 (
		.clk                 (clk_50mhz_clk_clk),                              //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	niosSystem_mm_interconnect_0_cmd_mux_002 cmd_mux_003 (
		.clk                 (clk_50mhz_clk_clk),                                   //       clk.clk
		.reset               (onchip_memory2_0_reset1_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	niosSystem_mm_interconnect_0_cmd_mux cmd_mux_004 (
		.clk                 (clk_50mhz_clk_clk),                              //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	niosSystem_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (clk_50mhz_clk_clk),                              //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	niosSystem_mm_interconnect_0_rsp_demux rsp_demux_001 (
		.clk                (clk_50mhz_clk_clk),                              //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	niosSystem_mm_interconnect_0_rsp_demux_002 rsp_demux_002 (
		.clk                (clk_50mhz_clk_clk),                              //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	niosSystem_mm_interconnect_0_rsp_demux_002 rsp_demux_003 (
		.clk                (clk_50mhz_clk_clk),                                   //       clk.clk
		.reset              (onchip_memory2_0_reset1_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	niosSystem_mm_interconnect_0_rsp_demux rsp_demux_004 (
		.clk                (clk_50mhz_clk_clk),                              //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	niosSystem_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (clk_50mhz_clk_clk),                              //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	niosSystem_mm_interconnect_0_rsp_mux_001 rsp_mux_001 (
		.clk                 (clk_50mhz_clk_clk),                              //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	niosSystem_mm_interconnect_0_avalon_st_adapter #(
		.inBitsPerSymbol (34),
		.inUsePackets    (0),
		.inDataWidth     (34),
		.inChannelWidth  (0),
